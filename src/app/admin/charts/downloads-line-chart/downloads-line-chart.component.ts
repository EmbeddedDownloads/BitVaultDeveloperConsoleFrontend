...
@Component({
  selector: 'app-downloads-line-chart',
  templateUrl: './downloads-line-chart.component.html',
  styleUrls: ['./downloads-line-chart.component.css']
})
export class DownloadsLineChartComponent implements OnInit {
  ...
  installLineGraph(): void {
    let body:any;
    body = {"applicationId": +this.utilsService.getAppID().id, "startDate":this.priorDate, "endDate":this.todayDate, "status": "download"}
