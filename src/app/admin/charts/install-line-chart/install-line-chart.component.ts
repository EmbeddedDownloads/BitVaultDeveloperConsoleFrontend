...
@Component({
  selector: 'app-install-line-chart',
  templateUrl: './install-line-chart.component.html',
  styleUrls: ['./install-line-chart.component.css']
})
export class InstallLineChartComponent {
  label:any=[];
  lineChartLabels:any=[];
  data:any=[];
  today:string;
  ...
  installLineGraph(): void {
    let body = {"applicationId": +this.utilsService.getAppID().id, "startDate":this.priorDate, "endDate":this.todayDate, "status": "install"}
