...
@Component({
  selector: 'app-dev-average-rating-chart',
  templateUrl: './dev-average-rating-chart.component.html',
  styleUrls: ['./dev-average-rating-chart.component.css']
})
export class DevAverageRatingChartComponent implements OnInit {
  ...
  installLineGraph(): void {
    let body:any;
    body = {"applicationId": +this.utilsService.devgetAppID().id, "startDate":this.priorDate, "endDate":this.todayDate, "status": "averageRating"}
