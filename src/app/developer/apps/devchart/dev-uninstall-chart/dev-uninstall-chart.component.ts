...
@Component({
  selector: 'app-dev-uninstall-chart',
  templateUrl: './dev-uninstall-chart.component.html',
  styleUrls: ['./dev-uninstall-chart.component.css']
})
export class DevUninstallChartComponent implements OnInit {
  ...
  installLineGraph(): void {
    let body:any;
    body = {"applicationId": +this.utilsService.devgetAppID().id, "startDate":this.priorDate, "endDate":this.todayDate, "status": "uninstall"}
  ...
  public lineChartData:Array<any> = [
    {data: this.data, label: 'Installs App'}
  ];
